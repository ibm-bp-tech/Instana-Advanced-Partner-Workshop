...
In this lab we learnt how to create smart alert for the robot shop application for calls with slow response time. Instana provides the ability to define alert conditions for various scenarios from within the context of application perspective. 
