...
In this lab we used a sample Robot Shop microservice application running as containerized application and generated load to the application, which will be later used to view key metrics about the application in Instana.
