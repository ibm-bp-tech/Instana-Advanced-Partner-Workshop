...
You will see a list of supported technologies in a table of icons. 

Select Linux Automatic Installation (one-liner) from the list.
...
![Lab 1](../Labs/images/lab1.5.1.png)
...
In this lab, we have learned how to install a host agent and verify the discovered host in the Infrastructure map view of Instana UI. 
