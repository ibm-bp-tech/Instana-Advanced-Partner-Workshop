...
In this lab we created custom event and verified that your event has triggered and review the event details. Besides the out of the box built-in events, users can define custom events based on the specific business requirements.
